...
function CrearCard(nombre,precio,imagen){
    ...
    card.innerHTML = `
        ...
        <div class="info__card">
            <p>$${precio}</p>
            <svg class="trash__icon" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
async function MostrarProductos(){
    try{
        ...
        lista.innerHTML = '<span class="info__productos">Ha ocurrido un problema con la conexion</span>';
    }
}
